...
export default function CoreStack() {
  ...
  // Safe manual mapping of keys to avoid type import issues with lucide-react dynamic loading
  ...
  // Raw data representing the primary top 5 key pillars in image 1
  const topPillars = [
    {
      id: "react",
      name: "React.js",
    ...
    <section id="stack" className="py-24 px-6 max-w-7xl mx-auto relative overflow-hidden">
      ...
      <div className="space-y-16">
        ...
        <div className="space-y-3">
          ...
          <p className="text-[#9ca3af] leading-relaxed text-sm md:text-base max-w-2xl font-sans">
            Standard engineering toolkit for robust, production-grade applications.
          </p>
        </div>

        {/* Dynamic upper grid: The 5 core tech pillars of Image 1 */}
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          {topPillars.map((pillar) => (
            ...
            >
              {/* Pillar Icon Box with smooth radial glow */}
        ...
        {/* Directory Wrapper Panel - Styled like Image 1 */}
        <div className="rounded-[2.5rem] border border-white/[0.05] bg-[#090a0b]/80 p-8 md:p-12 space-y-10 shadow-[0_30px_70px_rgba(0,0,0,0.4)] relative">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 border-b border-white/[0.04]">
            ...
            {/* Filter Chips - Styled exactly like the gray status pills in Image 1 */}
          ...
          {/* Core grid containing list elements */}
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <span className="text-[9px] font-mono font-medium text-[#9ca3af] uppercase tracking-wider block mt-0.5">
                    {skill.category === "AI WORKFLOWS" ? "AI WORKFLOWS" : skill.category}
                  </span>
                </div>
              </div>
            ))}
