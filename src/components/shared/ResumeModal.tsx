...
export default function ResumeModal({ isOpen, onClose }: ResumeModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto bg-black/80 backdrop-blur-md animate-fade-in print:p-0 print:bg-white print:relative print:-top-12">
      <div className="bg-[#0f1012] border border-brand-border w-full max-w-4xl rounded-3xl overflow-hidden shadow-2xl relative flex flex-col max-h-[90vh] print:max-h-none print:border-none print:shadow-none print:w-full print:bg-white print:text-black">
